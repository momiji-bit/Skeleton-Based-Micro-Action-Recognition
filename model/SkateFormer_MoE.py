...
class MOE(nn.Module):
    def __init__(self, in_features, hidden_features, act_layer, num_experts=4, drop=0., gating_hidden_dim=128):
...
class SkateFormerBlock(nn.Module):
    ...
    def forward(self, input):
        ...
        # Feed Forward
        output = output + self.drop_path(self.moe(self.norm_2(output)))
